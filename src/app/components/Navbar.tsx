  ...
  return (
    ...
    <nav className='w-full flex justify-between py-2'>
            <Link className="mr-2 relative flex items-center" href="/">
                ...
                <p className='text-2xl font-extrabold '>CodeMonkey</p>
            </Link>
            <div className='flex'>
                ...
                <div className='mx-3 my-auto text-mg font-semibold flex items-center blue-button-gradient text-white px-6 py-2 rounded-md hover:bg-blue-800 cursor-pointer'>
                    Book a call
                </div>
            </div>
    </nav>
