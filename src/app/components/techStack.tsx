    ...
    <section className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-start lg:px-8 py-16 w-full">
      <div className="w-full lg:w-1/2 mb-8 md:mb-0">
        ...
        <p className="text-lg mb-4">
          At CodeMonkey, we leverage cutting-edge technology to deliver top-tier
          performance and unbeatable security.
        </p>
        <button aria-label="Explore all our integrations and languages" className="py-4  group hover:bg-gray-50 hover:pr-7 rounded-xl drop-shadow-md">
        ...
        {groupedTechData.map((group, rowIndex) => (
          <div key={rowIndex} className="flex justify-end items-center mb-4">
            {group.map((tech) => (
              ...
              >
                <span className="absolute top-0 left-0 right-0 mx-auto text-center text-black text-sm font-bold opacity-0 group-hover:opacity-100 transform group-hover:-translate-y-2 transition-all duration-300">
                  {tech.name}
                </span>
      ...
      <div className="flex flex-col lg:hidden  gap-5  overflow-hidden">
        ...
        <div>
          ...
          <div className="flex justify-around w-full slide-animation-left">
          ...
          <div className="flex justify-around w-full gap-3 slide-animation-left">
            {[...TechData].reverse().map((d) => (
              <Image
                src={d.icon}
                alt={d.name}
